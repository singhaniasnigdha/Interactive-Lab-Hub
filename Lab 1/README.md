...
The set up for the interaction video is identical to what was used earlier (in part 1). The animated emoticons were built using Apple Memoji, Tenor (GIF search engine) and Microsoft Powerpoint.
